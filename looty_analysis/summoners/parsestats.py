        ...
        for donger in donger_this_shit:
            ...
            for dongturdchunk in dongturd: # EX: = aggregatedStats:|totalTurretsKilled:26;totalChampionKills:738;totalAssists:1797|
                if "aggregatedStats" in dongturdchunk:
                    ...
                    aggstats_block = aggstats_block + "<b>AGGREGATED STATS:</b><br>"
                    
                    for eachstat in eachstatset:
                        tinystats = eachstat.partition(':')
                        aggstats_block = aggstats_block + "<b>OMG? " + tinystats[0] + ":</b> <i>" + tinystats[2] + "</i><br>"
                    ...
                    if "playerStatSummaryType" in dongturdchunkdrop[0]:
                        ...
                        allotherstats_block = allotherstats_block + "<b>WTF? " + dongturdchunkdrop[0] + ":</b> " + dongturdchunkdrop[2] + "<br>"

            statsdata_all += gametype_header + allotherstats_block + aggstats_block + "<br>&nbsp;<br><b>" + str(i) + "</b><br>&nbsp;<br>"
            gametype_header = ""
            allotherstats_block = ""
            aggstats_block = ""
            i += 1
